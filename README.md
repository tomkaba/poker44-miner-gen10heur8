# poker44-miner-gen10heur8

Minimal release repository for model gen10heur8.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen10heur8.git
cd poker44-miner-gen10heur8
python3 -m venv .venv
...
- Scorer is hardcoded to `gen10heur8`.
